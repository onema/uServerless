...
//  "A validation service " should "return a bad request exception" in {
//
//    // Arrange
...
//  }
//
//  "A validation service " should "return a another bad request exception" in {
//
//    // Arrange
//    val request = new AwsProxyRequest
//    val context = new MockLambdaContext
...
//  }
//
//  "A validation service " should "return not fail when validation succeeds" in {
//
//    // Arrange
//    val request = new AwsProxyRequest
//    val context = new MockLambdaContext
